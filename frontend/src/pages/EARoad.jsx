  ...
  return (
    <div className="min-h-screen bg-space-portal text-slate-100 relative">
        ...
        <div className="relative group flex justify-center">
          <div className="aspect-square w-full max-w-lg glass-panel rounded-[60px] flex items-center justify-center p-12 border border-white/10 shadow-2xl relative overflow-hidden">
            ...
            {nodeRotations.map((rotate, i) => (
              <div 
                key={i} 
                className="absolute w-3 h-3 bg-rp-gold rounded-full shadow-[0_0_20px_#b45309] group-hover:scale-150 transition-transform duration-500"
          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {REGIONAL_GOALS.map((goal, i) => (
                <div key={i} className="p-8 rounded-[32px] glass-panel border border-white/5 hover:border-rp-blue/40 transition-all duration-500 group">
                  <div className="w-8 h-8 bg-rp-blue/10 rounded-xl flex items-center justify-center text-[10px] text-rp-blue font-black mb-4 group-hover:bg-rp-blue group-hover:text-white transition-all">
                    0{i + 1}
                  </div>
      ...
      <section className="py-24 bg-rp-blue relative overflow-hidden group">
        ...
        <div className="whitespace-nowrap flex animate-marquee gap-24">
